...
const PaymentModal = ({
  ...
  loading,
  estimatedCost,
  sessionExchangeRates,
}) => {
  const exchangeRates = {
    USD: 1,
    INR: sessionExchangeRates?.inrRate || 86.32655245,
    GBP: sessionExchangeRates?.gbpRate || 0.76905785,
  };
  ...
  const handleConfirmClick = () => {
    // Pass the exact amount, currency, and the fully converted cost to parent
    ...
    <div className="fixed inset-0 z-50 bg-black bg-opacity-50 flex items-center justify-center p-4">
      ...
      <div className="bg-white w-full max-w-md p-6 rounded-lg shadow-xl relative">
        ...
        <div className="text-right text-sm text-gray-600">
          ...
          {currencySymbols[selectedCurrency]}
          {maxPayment.toLocaleString()} {selectedCurrency}
        </div>
